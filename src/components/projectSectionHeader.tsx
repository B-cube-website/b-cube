...
export default function ProjectSectionHeader({ title }: ProjectSectionHeaderProps) {
  return (
    <section className="flex flex-col justify-center items-center w-full gap-2 mt-12 sm:mt-36">
      <h2
        className="w-full text-3xl sm:text-5xl font-semibold text-center"
        style={{
